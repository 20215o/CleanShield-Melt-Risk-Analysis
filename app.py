...
How to Use
Data Source: Select curated data, upload a CSV, or provide a URL with columns: pm25, temperature, humidity, elevation, albedo, solar_radiation, wind_speed, snow_depth, precipitation, melt_risk.
Explore: Preview data and train the model.
Visualize: Analyze trends with multiple plots.
Predict & Act: Get risk predictions, alerts, and an action plan.
...
Engage community leaders. """ st.text(action_plan) st.download_button(label="Download Action Plan (Text)", data=action_plan, file_name=f"action_plan_{prediction:.0f}.txt", mime="text/plain") st.write("Download this text plan to share with your community.") 